    ...
    with connection.cursor() as cursor:
        ...
        try:
            ...
            if cursor.rowcount > 0 :
                ...
                new_name = input("New value for Name: ")
                if len(new_name)>0:
                ...
                new_gender = input("New value for Gender: ")
                if len(new_gender)>0 :
                ...
                new_address = input("New value for Address: ")
                ...
                new_birthdate = input("New value for Birthdate: ")
                ...
                new_birthplace = input("New value for Birthplace: ")
                ...
                new_status = input("New value for Status: ")
                if len(new_status) > 0:
...
while loop:
    ...
    if choice == '1':
        ...
        birthplace      = input("Enter Birth of Place: ")
        ...
        emp_id = input("What Data you want to Update (Enter ID to proceed) ?: ")
        update_record(emp_id)
    elif choice == '4':
        emp_id = input("What Data you want to Delete (Enter ID to proceed) ?: ")
        ...
        search_choice = input("What do you want to search?: ").strip()
